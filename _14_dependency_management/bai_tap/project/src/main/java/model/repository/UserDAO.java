...
public class UserDAO implements IUserDAO {
    ...
    private String jdbcPassword = "Rong2dau";
    ...
    public List<User> selectUserByCountry(String country) throws SQLException {
        ...
        try (Connection connection = getConnection();
             ...
             PreparedStatement preparedStatement = connection.prepareStatement("select * from users where country like '%" + country + "%'")) {
//            preparedStatement.setString(1, country);
    ...
    public List<User> selectUserCallStatement() {
        ...
        try {
            ...
            CallableStatement callableStatement = conn.prepareCall("call select_all()");
    ...
    @Override
    public boolean updateUserTransaction(User user) {
        boolean rowUpdated = false;
        try (Connection connection = getConnection(); CallableStatement statement = connection.prepareCall("call update_user(?,?,?,?)")) {
